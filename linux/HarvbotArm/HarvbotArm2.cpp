...
: HarvbotArm(ArmType2) {
	...
	this->nodes[0] = new HarvbotArmStepperCircleNode(Bedplate, HARVBOT_ARM_SX_STEP, HARVBOT_ARM_SX_DIR, HARVBOT_ARM_SX_END, 3400, 45.0f, 0.0f, 360.0, 200, HARVBOT_ARM_SX_RATIO);
