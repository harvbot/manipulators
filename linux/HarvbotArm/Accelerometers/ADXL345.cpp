...
float AccelData::gx() { return (float)x;}// tog(scale_g, x); }
float AccelData::gy() { return (float)y;}//tog(scale_g, y); }
float AccelData::gz() { return (float)z;}//tog(scale_g, z); }
...
/***************************************************************
*
*! @brief       interrupt function for accle data updated in ADXL345,\
*		will be call by IO interrupt.
*! @note        you can add your code here for data receive.
*! @param       void.
*! @retval      void.
*
* **************************************************************/
bool dataUpdate_flag = 0;
void dataUpdate_int(void)
{
        dataUpdate_flag = 1;
}
...
/****************************************************************
*
*! @brief       interrrupt function for activity catch in ADXL345,\
*		will be call by IO interrupt.
*! @note        you can add your code here for activity event.
*! @param       none.
*! @retval      none.
*
******************************************************************/
bool activity_flag = 0;
void activity_int(void)
{
        activity_flag = 1;
}
...
/******************************************************************
*
*! @brief       interrupt function for inactivity catch in ADXL345,\
*		will be call by IO interrupt.
*! @note        you can add your code here for activity event.
*! @param       none.
*! @retval      none.
*
* ******************************************************************/
bool inactivity_flag = 0;
void inactivity_int(void)
{
        inactivity_flag = 1;
}
